...
<?
	...
	{
		$type_title = "댓글 등록";
		//$retUrl = "board_detail.php?board=". $board ."&page=". $page ."&keyfield=". $keyfield ."&keyword=". $keyword ."&seqno=". $seqno ."&type=ret";
		$retUrl = "board_detail.php?page=". $page ."&keyfield=". $keyfield ."&keyword=". $keyword ."&seqno=". $seqno ."&type=ret";
