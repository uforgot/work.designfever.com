                        ...
                        <div class="calendar-body">
                            ...
                            while ($record = sqlsrv_fetch_array($rs))
                            {
                                ...
                                if ($count == 1)
                                {
                                    ...
                                    for ($i=0; $i<$day_cnt; $i++)
                                    {
                                        echo "<div class='calendar-date'><div class='date'></div></div>";
                                        $lastday++;
                                    }
                                }
                                ...
                                {
                                    echo "<div class='calendar-date is-today'><div class='date'>". $count ."</div></div>";
                                }
                                else if($col_date_name != "") //공휴일 표시
                                {
                                    echo "<div class='calendar-date'><div class='date'>". $count ."</div></div>";
                                }
                                ...
                                else
                                {
                                    ...
                                    {
                                        echo "<div class='calendar-date is-holiday'><div class='date'>". $count ."</div></div>";
                                    }else
                                    {
                                        echo "<div class='calendar-date'><div class='date'>". $count ."</div></div>";
                                    }
