...
<!-- pop -->
    <section class="modal-card-body modal-commuting-modify">
        <div class="">
            <div class="columns is-mobile">
                <div class="column">
                    <span><?=$md_name?> : <?=substr($p_date,5,2)?>월 <?=substr($p_date,8,2)?>일<span>
                <? if ($md_checktime1 != "" || $md_checktime2 != "") { ?>
                    <a class="button" href="javascript:fdelete();">근태기록삭제</a>
                <? } ?>
                   </span>
                <div class="edit_wrap">
                    <table class="notable edit_table"  width="100%">
                        ...
                        <tr>
                            <td colspan="3">
                                <select name='gubun' onchange="fcheck();">
                                    <option value="">--</option>
    ...
    <footer class="modal-card-foot">         
        ...
        <a  class="button is-danger"href="javascript:closePop('DayEdit');">취소</a>
    </footer>
    </div>
    <!-- //pop -->
</form>
