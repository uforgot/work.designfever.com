...
<script type="text/javascript">
	function modify(){
		...
		if (frm.gubun2_hour.value.length != 0 && frm.gubun2_minute.value.length != 0)
		{		
		...
		frm.gubun1.disabled = false;
		frm.gubun2.disabled = false;
		frm.gubun1_hour.disabled = false;
		frm.gubun1_minute.disabled = false;
		frm.gubun2_hour.disabled = false;
		frm.gubun2_minute.disabled = false;
		...
		-->
			<div class="edit_wrap">
				<table class="notable edit_table" width="100%">
					...
					<tr>
						<th rowspan="3" class="edit"><font color="#ffcc00">*요청</font></th>
						<td colspan="3">
					...
					<tr>
						<td>
							<select name='gubun1' style="width:100px;" <?=$gubun1_disabled?>>
								<option value="">--</option>
						...
						<td>
							<select name='gubun1_hour' disabled="disabled">
								<option value="">--</option>
							<?
								for ($i=0; $i<=23; $i++)
								{
							...
							&nbsp;&nbsp;:&nbsp;&nbsp;
							<select name='gubun1_minute' disabled="disabled">
								<option value="">--</option>
							<?
								for ($i=0; $i<=59; $i++)
								{
					...
					<tr>
						<td>
							<select name='gubun2' style="width:100px;" <?=$gubun2_disabled?>>
								<option value="">--</option>
						...
						<td>
							<select name='gubun2_hour' disabled="disabled">
								<option value="">--</option>
							<?
								for ($i=0; $i<=48; $i++)
								{
							...
							&nbsp;&nbsp;:&nbsp;&nbsp;
							<select name='gubun2_minute' disabled="disabled">
								<option value="">--</option>
							<?
								for ($i=0; $i<=59; $i++)
								{
