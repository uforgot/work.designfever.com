<?php
	...
	//행복연구소 
	//$happyLab_arr = array('김자연','강기모','김숙진','윤다윤','임우리','김유리','김민경','안지혜','박현정','김명진','배유리','서효정');
	$happyLab_arr = array('161','151','26','172','193','190','118','128','189','112','28','197');

	//경영지원팀
	//$business_arr = array('김숙진','김은경','정민선','김요진');
	$business_arr = array('26','290','328','329');
...
*/
	...
	// 디바이스 권한 배열
	$_equip_auth_arr = array ("15", "79", "80", "26", "85", "109", "290", "328", "329");

	// 테스트 디바이스 권한 배열
	$_equip_test_auth_arr = array ("15", "79", "80", "26", "85", "109", "290", "328", "329", "100", "279"); // 곽병준, 이설란 추가
?>
