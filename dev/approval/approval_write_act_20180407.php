...
<?
	...
	} else if ($form_category == "프로젝트 관련품의서" || $form_category == "비용품의서" || $form_category == "비용품의서(v2)" || $form_category == "사유서" || $form_category == "시말서" 
				|| ($form_category == "휴가계" && strstr($form_title,"프로젝트"))) {
