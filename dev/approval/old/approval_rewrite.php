						...
						?>
									...
									<tbody>
										<tr>
											<th>항목<?=$expense+1?></th>
											<td align="left">
												<input id="memo_<?=$expense?>" name="memo" class="df_textinput" type="text" style="width:400px;" value="<?=$expense_memo?>">
											</td>
											<th>금액</th>
											<td>
												<input id="money_<?=$expense?>" name="money" class="df_textinput" type="text" style="ime-mode:disabled;width:100px;" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) { event.returnValue = false; }" onKeyup="javascript:checkThousand(this,this.value);" value="<?=$expense_moeny?>">
											</td>
											<th>실비여부</th>
											<td>
												<input type="checkbox" name="actual" value="Y"<? if ($expense_actual == "Y") { echo " checked"; } ?>>
												<input type="hidden" name="idx" value="<?=$expense?>">
											</td>
										</tr>
									</tbody>
									</table>
							...
							?>
									...
									<tbody>
										<tr>
											<th>항목<?=$i+1?></th>
											<td align="left">
												<input id="memo_<?=$i?>" name="memo" class="df_textinput" type="text" style="width:400px;" value="">
											</td>
											<th>금액</th>
											<td>
												<input id="money_<?=$i?>" name="money" class="df_textinput" type="text" style="ime-mode:disabled;width:100px;" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) { event.returnValue = false; }" onKeyup="javascript:checkThousand(this,this.value);" value="">
											</td>
											<th>실비여부</th>
											<td>
												<input type="checkbox" name="actual" value="Y">
