...
<?
	...
	$searchSQL = " WHERE PRS_ID = '$prs_id' AND STATUS = '임시' AND USE_YN = 'Y' AND CONVERT(char(10),REG_DATE,120) BETWEEN '$fr_date' AND '$to_date'";
	if ($p_category != "")
	{
		if ($p_category == "품의서")
		{
...
?>
							<tr>
								...
								<td class="last">
									<a href="javascript:funModify('<?=$doc_no?>');"><img src="/img/btn_writeApprove1_modify.gif" alt="수정"></a>
									<a href="javascript:funDelete('<?=$doc_no?>');"><img src="/img/btn_writeApprove1_delete.gif" alt="삭제"></a>
								</td>
							</tr>
<?
				}
...
<?
			...
			else
			{
				...
				if($form_category == "비용품의서" || $form_category == "프로젝트 관련품의서") {		// 구버전 품의서인 경우
					...
					$modify_link = "<a href=\"javascript:funModify_old('{$doc_no}');\"><img src=\"/img/btn_writeApprove1_modify.gif\" alt=\"수정\"></a>";
				} else {
					$view_link   = "<a href=\"javascript:funView('{$doc_no}');\">{$title}</a>";
					$modify_link = "<a href=\"javascript:funModify('{$doc_no}');\"><img src=\"/img/btn_writeApprove1_modify.gif\" alt=\"수정\"></a>";
				}
				$delete_link = "<a href=\"javascript:funDelete('{$doc_no}');\"><img src=\"/img/btn_writeApprove1_delete.gif\" alt=\"삭제\"></a>";
?>
							<tr>
								<td><?=$i?></td>
								<td>-</td>
...
<div id="popDel" class="approval-popup5" style="display:none;">
	<form name="form4" method="post">
	<input type="hidden" name="doc_no" id="del_doc_no">
	<div class="pop_top">
		<p class="pop_title">삭제</p>
		<a href="javascript:HidePop('Del');" class="close">닫기</a>
	</div>
	<div class="pop_body">
		<p class="intra_pop_info">선택하신 문서를 삭제 하시겠습니까?</p>
		<div class="edit_btn">
			<a href="javascript:funDeleteOk();"><img src="/img/btn_ok.gif" alt="확인"></a>
			<a href="javascript:HidePop('Del');"><img src="/img/btn_cancel.gif" alt="취소"></a>
		</div>
	</div>
	</form>
</div>
