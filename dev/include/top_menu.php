...
<div class="top">
    <!-- mobile menu-->
    <div id="work-menu" class="navbar-menu">
        ...
        <div class="menu">
            <div class="navbar-brand">
                ...
                <div id="work-menuCloseBt" class="navbar-burger" href="#">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
            ...
            <div class="content">
                ...
                <div class="columns is-mobile">
                    <div class="column  is-size-7">
                        <a class="button is-primary is-fullwidth" href="javascript:logout();">
                            <strong>로그아웃</strong>
                        </a>
                    </div>
                    <div class="column">
            ...
            */
                        ...
                        if ($end_check == "Y")
                        {
                            ...
                            <? }else if ($today_checktime2 != "")												//퇴근 중복체크
                            {
                                ...
                                echo "<p class='control'>
                                            <a href=javascript:leave_office(2,'". $today_checktime1 ."','". $totaltime ."'); class='button is-fullwidth' href='#'>
                                                <span>퇴근하기</span>
                                            </a>
                                          </p>";
                            }
                            ...
                            {
                                echo "<p class='control'>
                                                <a href=javascript:leave_office(3,'". $yesterday_checktime1 ."','". $totaltime ."'); class='button is-fullwidth' href='#'>
                                                    <strong>퇴근하기</strong>
                                                </a>
                                        </p>";
                            }
                            ...
                            {
                                echo "<p class='control'>
                                                <a href=javascript:leave_office(4,'". $yesterday_checktime1 ."','". $totaltime ."'); class='button is-fullwidth' href='#'>
                                                    <strong>퇴근하기</strong>
                                                </a>
                                            </p>";
                            }
                            ...
                            {
                                echo "<p class='control'>
                                            <a href=javascript:leave_office(4,'". $yesterday_checktime1 ."','". $totaltime ."');class='button is-fullwidth>
                                                <strong>퇴근하기</strong>
                                            </a>
                                        </p>";
                            }
                            ...
                            {
                                echo "<p class='control'>
                                             <a href=javascript:leave_office(1,'". $today_checktime1 ."','". $totaltime ."'); class='button is-fullwidth' >
                                                 <strong>퇴근하기</strong>
                                             </a>
                                        </p>";
                            }
                ...
                <?	if ($prf_id == 7) {	?>
                    <a href="/main.php" <? if (substr(CURRENT_URL,0,5) == "/main") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>홈</span></a>
                    <a href="/commuting/commuting_list.php" <? if (substr(CURRENT_URL,0,10) == "/commuting") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>근태현황</span></a>
                    <a href="/book/book_list.php?board=edit" <? if (substr(CURRENT_URL,0,5) == "/book") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>근태수정요청</span></a>
                    <a href="/approval/approval_my_list.php" <? if (substr(CURRENT_URL,0,9) == "/approval") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>전자결재</span></a>
                    <a href="/board/board_list.php" <? if (substr(CURRENT_URL,0,6) == "/board") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>공지사항</span></a>
                <?	} else {	?>
                    <a href="/main.php" <? if (substr(CURRENT_URL,0,5) == "/main") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>홈</span></a>
                    <a href="/commuting/commuting_list.php" <? if (substr(CURRENT_URL,0,10) == "/commuting") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>근태</span></a>
                    <a href="/vacation/vacation_list.php" <? if (substr(CURRENT_URL,0,9) == "/vacation") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>휴가</span></a>
                    <a href="/approval/approval_my_list.php" <? if (substr(CURRENT_URL,0,9) == "/approval") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>전자결재</span></a>
                    <a href="/project/project_list.php" <? if (substr(CURRENT_URL,0,8) == "/project") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>프로젝트</span></a>
                    <a href="/weekly/weekly_list.php" <? if (substr(CURRENT_URL,0,7) == "/weekly") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>주간보고서</span></a>
                    <a href="/board/board_list.php" <? if (substr(CURRENT_URL,0,6) == "/board") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>공지사항</span></a>
                    <a href="/book/book_list.php" <? if (substr(CURRENT_URL,0,6) == "/book") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>게시판</span></a>
                    <a href="/booking/booking_list.php" <? if (substr(CURRENT_URL,0,8) == "/booking" || substr(CURRENT_URL,0,6) == "/visit") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>예약</span></a>
                    <a href="/org_chart/person_list.php" <? if (substr(CURRENT_URL,0,5) == "/org_") { ?> class="navbar-item is-active"<? }else {?>class="navbar-item"<?}?> href="#"><span>조직도</span></a>
                    <!--<a href="/equipment/info_workdevice.html" class="navbar-item " href="#"><span>장비관리</span></a>-->
                <?	}	?>
            </div>
        </div>
    </div>
    ...
    <nav id="navbar" class="navbar has-shadow is-fixed-top">
        <div class="container">
            <div class="navbar-brand">
                ...
                <div id="work-menuOpenBt" class="navbar-burger" href="#">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
