...
<?
	...
	if($next_week) $next_link = "<a href='weekly_list_sum_type2.php?week=".$next_week."&team=".$team."'>▶</a>";
	else $next_link = "▶";
	...
	if($prev_week) $prev_link = "<a href='weekly_list_sum_type2.php?week=".$prev_week."&team=".$team."'>◀</a>";
	else $prev_link = "◀";
...
<script type="text/javascript">
	function weekSearch(val) {
		document.location.href = "./weekly_list_sum_type2.php?week=" + val + "&team=<?=$team?>";
	}
	...
	function teamSearch(val) {
		...
		document.location.href = "./weekly_list_sum_type2.php?week=<?=$week?>&team=" + val;
	}
</script>
</head>
<body>
