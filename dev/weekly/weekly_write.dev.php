...
<?
	...
	$prs_position_tmp = (in_array($prs_name,$positionC_arr)) ? "팀장" : "";	//팀장대리 판단
	...
	<? include INC_PATH."/top_menu.php"; ?>
		...
		<div class="inner-home">
			...
			<? if (in_array($prs_position,$positionB_arr)) { ?>
				<a href="#"><strong>+  주간보고서 작성</strong></a>
				<a href="weekly_list.php">+  주간보고서 목록</a>
			<? } ?>
			<? if ($prs_position == '팀장' || $prs_position_tmp == '팀장') { ?>
				<a href="weekly_list_team.php">+  팀원 주간보고서</a>
			<? } else if (in_array($prs_position,$positionA_arr)) { ?>
				<a href="weekly_list_team.php">+  실 주간보고서</a>
			<? } ?>
			</p>
