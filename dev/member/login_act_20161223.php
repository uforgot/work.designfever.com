...
<?
	...
	$sql = "SELECT 
				PRS_ID, PRF_ID, PRS_NAME, PRS_TEAM, PRS_POSITION, PRS_EMAIL, PRS_TEL, PRS_EXTENSION, PRS_MEMO1, PRS_MEMO2, FILE_IMG, PRS_PASSWD, PRS_PWD
	...
	else
	{
		if ($col_prs_pwd != "") 
		{
			if (validate_password($user_pw, $col_prs_pwd)) { 
				// session 
