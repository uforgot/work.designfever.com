...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		if (!inst.inline) {
			...
			inst.dpDiv.css( "z-index", datepicker_getZindex( $( input ) ) + 999 ); //bulma z-index값이 2로 설정되어있어서 999로 수정 ksyang
	...
	_generateHTML: function(inst) {
		...
		controls = (!inst.inline ? "<a href='javascript:datepickerClose();'><img src='/img/btn_x.gif'></a>" : "");

		buttonPanel = (showButtonPanel) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (isRTL ? controls : "") + (isRTL ? "" : controls) + "</div>" : "";
